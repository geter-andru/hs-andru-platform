...
export const airtableService = {
  ...
  createDefaultAssessment(customerData) {
    const isAdmin = customerData.customer_id === 'druAdminDemo2025';
  ...
  assessPerformanceFromData(customerData) {
    ...
    if (customerData.customer_id === 'druAdminDemo2025') {
  ...
  calculateRevenueOpportunity(performance, customerData) {
    const baseOpportunity = customerData.customer_id === 'druAdminDemo2025' ? 1200000 : 750000;
