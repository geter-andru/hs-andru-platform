...
export const UserIntelligenceProvider = ({ children, customerId }) => {
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      ...
      if (customerId.includes('TEST') || customerId === 'druAdminDemo2025' || customerId === 'CUST_4' || customerId === 'druTestUser00001' || customerId === 'CUST_02' || customerId === 'CUST_2') {
      ...
      if (customerId.includes('TEST') || customerId === 'druAdminDemo2025' || customerId === 'CUST_4') {
