...
export const UserIntelligenceProvider = ({ children, customerId }) => {
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      ...
      if (customerId.includes('TEST') || customerId === 'dru78DR9789SDF862' || customerId === 'CUST_4' || customerId === 'dru9K2L7M8N4P5Q6' || customerId === 'CUST_02' || customerId === 'CUST_2') {
      ...
      if (customerId.includes('TEST') || customerId === 'dru78DR9789SDF862' || customerId === 'CUST_4') {
